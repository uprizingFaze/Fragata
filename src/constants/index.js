...
export const features = [{
        ...
        icon: shield,
        title: "Seguridad",
        content: "Proporcionar a nuestros clientes una seguridad informática sólida y confiable.",
    },
    {
        id: "feature-2",
        icon: star,
    ...
    },
    {
        ...
        icon: send,
        title: "Eficacia",
        content: "Mejorar la eficiencia y la productividad de nuestros clientes.",
    },
];
